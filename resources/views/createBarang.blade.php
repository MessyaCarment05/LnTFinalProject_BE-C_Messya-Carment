...
<form action="/store-barang" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-4">
      ...
      <input type="text" class="form-control" id="validationDefault01" name="nama_barang" required minlength="5" maxlength="80">
    </div>
    <div class="col-md-4">
        ...
        <div class="input-group">
          <span class="input-group-text" id="inputGroupPrepend2">Rp. </span>
           <input type="integer" class="form-control" id="validationDefault01" name="harga">
          </div>  
      </div>
      <div class="col-md-4">
        <label for="validationDefault01" class="form-label">Jumlah Product</label>
        <input type="integer" class="form-control" id="validationDefault01" name="jumlah">
      </div>
      <div class="mb-3">
